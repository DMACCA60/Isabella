      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-[#1b2421]/75 leading-relaxed">
            Hiring managers are invited to explore the interactive geospatial simulations below, representing Isabella McInnes's actual coursework and placement portfolio. These models showcase advanced environmental due diligence, coastal photogrammetry, and Python script automation.
          </p>
        </div>
          ...
          {PROJECTS.map((project) => {
            ...
            return (
              <button
                ...
                className={`px-5 py-3 rounded-xl font-sans text-sm font-bold tracking-wide transition-all duration-300 text-left shrink-0 cursor-pointer flex items-center justify-between gap-3 ${
                  activeTab === project.id
                    ? 'bg-[#2a473d] text-[#fcfbf9] shadow-sm'
                    : 'text-[#4a6b5d] hover:bg-[#e6e3dd]/50 hover:text-[#1b2421]'
                }`}
              >
                ...
                <span className={`text-[10px] uppercase tracking-wider font-bold px-2 py-0.5 rounded-md ${
                  ...
                  {project.id === 'commercial-app' ? 'Due Diligence' : 
                   project.id === 'technical-app' ? 'Remote Sensing' : 'Automation'}
                </span>
              </button>
            );
          })}
