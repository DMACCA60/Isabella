...
export const CV_PROFILE = {
  ...
  summary: "I'm a Geography Graduate & GIS Specialist passionate about environmental mapping and spatial data analysis, with proven commercial experience delivering Residential Agricultural Land Reports (RALR) within a consultancy environment, identifying environmental liabilities and flood zone designations. Highly skilled in processing UAV-SfM photogrammetry, building Digital Elevation Models (DEMs), and applying statistical modelling to understand climate resilience and geomorphic risk. Actively seeking a graduate role in environmental consultancy or geospatial surveying."
};
...
export const PROJECTS: Project[] = [
  {
    ...
    tools: ["QGIS", "Ordnance Survey MasterMap", "Magic Map Data", "Spatial Join", "Buffer Analysis"],
...
export const SKILL_CATEGORIES: SkillCategory[] = [
  {
    ...
    icon: "Map",
    skills: ["QGIS", "ArcGIS Pro", "MapInfo", "Magic Mapping", "Ordnance Survey Data Integration", "DEM of Difference (DoD) Analysis", "Spatial Masking", "Network Analysis", "Buffer & Proximity Analysis"]
  },
  {
...
export const EXPERIENCE: ExperienceEntry[] = [
  {
    ...
    points: [
      ...
      "Evaluated site variability for land and property transactions using professional geospatial tools (Ordnance Survey MasterMap, Magic Mapping).",
...
export const AFFILIATIONS = [
  ...
  },
  {
    ...
    detail: "Full Clean UK Driving License (2 years); First Aid Trained."
  }
];
